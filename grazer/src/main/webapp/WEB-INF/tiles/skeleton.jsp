          ...
          <sec:authorize access="isAuthenticated()">
            <div class="container">
              <div class="row" style="padding-top: 15px;">
                ...
                <button type="button" class="btn btn-link pull-right"><i class="fa fa-upload"></i><a href="${pageContext.servletContext.contextPath}/transformation/add"> Upload transformation files</a></button>
              </div>
            </div>
          </sec:authorize>
