          ...
          <sec:authorize access="isAuthenticated()">
            <div class="container">
              <div class="row" style="padding-top: 15px;">
                ...
                <button type="button" class="btn btn-link pull-right"><a href="${pageContext.servletContext.contextPath}/admin/api/transformations/start">Start cron job</a></button>
              </div>
            </div>
          </sec:authorize>
